...
const AddBlog = () => {
  ...
  const [formData, setFormData] = useState({
    title: '', category: '', content: '', status: 'Draft', thumbnail: null,
  });
  ...
  const handleReset = () => {
    setFormData({ title: '', category: '', content: '', status: 'Draft', thumbnail: null });
    setErrors({});
    setPreview(null);
  };

  return (
    <AdminLayout title="Thêm bài viết">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                ...
                <textarea className={`form-control bg-dark border-0 text-light ${errors.content ? 'is-invalid' : ''}`}
                  name="content" placeholder="Nhập nội dung bài viết..." rows={6}
              ...
              <div className="d-flex gap-2">
                <button type="submit" className="btn btn-primary px-4">
                  <i className="fa fa-save me-2"></i>Lưu bài viết
                </button>
                <button type="button" className="btn btn-outline-secondary px-4" onClick={handleReset}>
                  <i className="fa fa-redo me-2"></i>Nhập lại
                </button>
              </div>
            </form>
          </div>
        ...
        <div className="col-12 col-xl-4">
          <div className="bg-secondary rounded p-4">
            ...
            <ul className="text-light ps-3" style={{ fontSize: '0.9rem' }}>
              <li className="mb-2">Tiêu đề nên ngắn gọn và thu hút.</li>
              <li className="mb-2">Chọn đúng danh mục để dễ tìm kiếm.</li>
              <li className="mb-2">Lưu <strong>Nháp</strong> để xem lại trước khi đăng.</li>
              <li className="mb-2">Ảnh thumbnail nên là <strong>800x400px</strong>.</li>
            </ul>
          </div>
        </div>
      </div>
